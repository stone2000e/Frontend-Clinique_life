          ...
          <>
            ...
            >
              ...
              <div className="relative flex items-center gap-3 mb-8 sm:mb-10 mt-8 bg-blue-50/50 backdrop-blur-sm rounded-2xl p-4 shadow-md">
                ...
                <div>
                  <span className="block font-bold text-[#134774] text-base sm:text-lg whitespace-nowrap">
                    Clinique Life
                  </span>
                  <span className="block text-xs text-gray-500 whitespace-nowrap">Votre santé, notre priorité</span>
                </div>
              </div>
                    ...
                    {subMenu ? (
                      ...
                      <div>
                        <button
                          ...
                          className="w-full relative px-4 py-3 rounded-xl font-poppins font-medium transition-all flex items-center justify-between gap-3 group text-[#134774] hover:bg-white/60 hover:shadow-md"
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-lg flex items-center justify-center transition-all bg-blue-100 group-hover:bg-blue-200">
                              <Icon className="w-5 h-5 text-[#134774]" />
                            </div>
                            ...
                            >
                              {subMenu.map((item) => (
                                <NavLink
                                  ...
                                  onClick={() => setIsOpen(false)}
                                  className={({ isActive }) =>
                                    `relative px-4 py-2.5 rounded-lg font-poppins font-medium transition-all flex items-center gap-3 group
                                    ${isActive 
                                      ? "bg-gradient-to-r from-[#05D2CE] to-[#007E7B] text-white shadow-lg" 
                                      : "text-[#134774] hover:bg-blue-50 hover:shadow-md"}`
                                  }
                                >
                                  {({ isActive }) => (
                                    <>
                                      <div className={`w-7 h-7 rounded-lg flex items-center justify-center transition-all ${isActive ? 'bg-white/20' : 'bg-blue-50 group-hover:bg-blue-100'}`}>
                                        <item.icon className={`w-4 h-4 ${isActive ? 'text-white' : 'text-[#134774]'}`} />
                                      </div>
