...
const team: TeamMember[] = [
  {
    ...
    image: "/images/team/kouassi.jpg", // Remplacer par le vrai chemin
    responsibilities: [
      "Superviser l'ensemble des activités médicales de la clinique",
      "Assurer la qualité des soins fournis",
      "Gérer les relations avec les partenaires et les fournisseurs",
    ],
    experience: "20 ans",
    phone: "+225 01 23 45 67 89",
    email: "emmanuel.kouassi@cliniquelife.com",
  },
  {
    ...
    responsibilities: [
      "Assurer le suivi médical des enfants de 0 à 18 ans",
      "Coordonner les soins pédiatriques",
      "Former l'équipe sur les protocoles pédiatriques",
    ],
    experience: "12 ans",
    phone: "+225 01 23 45 67 90",
    email: "aminata.traore@cliniquelife.com",
  },
  {
    name: "Mme. Adjoua Koffi",
    role: "Infirmière en Chef",
    specialty: "15 ans d'expérience en soins d'urgence",
    image: "/images/team/adjoua.jpg",
    responsibilities: [
  ...
  },
  {
    ...
    image: "/images/team/kone.jpg",
    responsibilities: [
      "Effectuer les analyses biologiques",
      "Assurer la qualité des résultats",
      "Gérer l'équipement du laboratoire",
    ],
    experience: "10 ans",
    phone: "+225 01 23 45 67 94",
    email: "kone.ibrahim@cliniquelife.com",
  },
];
      ...
      {selectedMember && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full overflow-hidden shadow-2xl">
            ...
            <div className="relative h-32 bg-gradient-to-r from-[#0066FF] via-[#00A0E9] to-[#00C9B7] p-6">
              {/* BOUTON FERMER */}
              <button
