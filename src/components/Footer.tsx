      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            <a href="https://web.facebook.com/cliniclife8/?_rdc=1&_rdr#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-blue-600 flex items-center justify-center transition">
              {FaFacebookF({ size: 18 })}
            </a>

            <a href="https://wa.me/2250554176268" className="w-10 h-10 rounded-full bg-white/10 hover:bg-emerald-500 flex items-center justify-center transition">
              {FaWhatsapp({ size: 20 })}
            </a>
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400">
            ...
            <li className="flex items-center gap-3">
              ...
              Angré GESTOCI (100 m après CHINA MALL)
            </li>
          </ul>
        </div>
